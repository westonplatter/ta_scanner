...
from ta_scanner.indicators import IndicatorSmaCrossover, IndicatorEmaCrossover, IndicatorParams
...
for i in range(0, 33):
    ...
    results = run_cross_range(df_train, slow_sma=slow_sma, fast_sma_min=fast_sma_min, fast_sma_max=fast_sma_max)
    ...
    logger.info(f"--- CumulativePnL={test_total_pnl}. Trades Count={test_total_count}. After={initial}")
